(function(c){var g={defaults:{animation:"horizontal-push",animationSpeed:600,timer:!0,advanceSpeed:4E3,pauseOnHover:!1,startClockOnMouseOut:!1,startClockOnMouseOutAfter:1E3,directionalNav:!0,captions:!0,captionAnimation:"fade",captionAnimationSpeed:300,bullets:!1,bulletThumbs:!1,bulletThumbLocation:"",afterSlideChange:c.noop,centerBullets:!0},activeSlide:0,numberSlides:0,orbitWidth:null,orbitHeight:null,locked:null,timerRunning:null,degrees:0,wrapperHTML:'<div class="orbit-wrapper" />',timerHTML:'<div class="timer"><span class="mask"><span class="rotator"></span></span><span class="pause"></span></div>',
captionHTML:'<div class="orbit-caption"></div>',directionalNavHTML:'<div class="slider-nav"><span class="right">Right</span><span class="left">Left</span></div>',bulletHTML:'<ul class="orbit-bullets" align="right"></ul>',init:function(a,b){var d,e=0,f=this;this.clickTimer=c.proxy(this.clickTimer,this);this.addBullet=c.proxy(this.addBullet,this);this.resetAndUnlock=c.proxy(this.resetAndUnlock,this);this.stopClock=c.proxy(this.stopClock,this);this.startTimerAfterMouseLeave=c.proxy(this.startTimerAfterMouseLeave,
...
this.$slides.each(this.addBullet);this.options.centerBullets&&this.$bullets.css("margin-left",-this.$bullets.width()/2)},addBullet:function(a,b){var d=c("<li>"+(a+1)+"</li>"),e,f=this;this.options.bulletThumbs&&(e=c(b).attr("data-thumb"))&&d.addClass("has-thumb").css({background:"url("+this.options.bulletThumbLocation+e+") no-repeat"});this.$bullets.append(d);d.data("index",a);
d.hover(function(){f.stopClock();f.$element.trigger("orbit.goto",[d.data("index")])})},setActiveBullet:function(){if(this.options.bullets)this.$bullets.find("li").removeClass("active").eq(this.activeSlide).addClass("active");
