...
<div id="header">
	...
	<div class="topmenu">
		...
		<a href="https://www.pass.com:444/?st=join"><img src="/img/integrate/top_icon02.gif" alt="회원가입" /></a>
			<img src="/img/integrate/top_iconbar.gif" alt="|" class="bar" />
	...
	<div id="boxes" >
		<div id="dialog" class="window" >
			...
			<form method="post" action="" name="" onsubmit>
				...
				<div class="loginBox">
					<div class="textInput">
						<p><label><img src="/img/integrate/login_textID.gif" alt="아이디" /></label><input type="text" class="text" value=""/></p>
						<p><label><img src="/img/integrate/login_textPW.gif" alt="비밀번호" /></label><input type="password" class="text" onkeyup=""/></p>
					</div>
